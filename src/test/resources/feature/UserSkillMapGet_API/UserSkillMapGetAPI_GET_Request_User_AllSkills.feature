...
@feature
Feature: Get request for a User with all skills 
  I want to use this template for my feature file

@Scenario01
Scenario: Get request for an User with all skills with valid authorization
Given user sends the get request to get an user with all skills records
When user sends the get request to get particular user record with endpoint url "https://springboot-lms-userskill.herokuapp.com/UserSkillsMap/US2858"
...
And check validation schema "Configuration/UserskillMapGet/LMS_Schema_UserSkillMapGetAPI_GET_User_All_Skills_Request.json"  	
  	
@Scenario02
Scenario: Get request for an non existing User with all skills with valid authorization
Given user sends the get request to get an user with all skills records
When user sends the get request to get particular user record with endpoint url "https://springboot-lms-userskill.herokuapp.com/UserSkillsMap/US2858234"
...
@Scenario03
Scenario: Get request for an invalid User with all skills with valid authorization
Given user sends the get request to get an user with all skills records
